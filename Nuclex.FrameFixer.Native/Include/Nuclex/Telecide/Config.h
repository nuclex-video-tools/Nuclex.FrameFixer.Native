...
#ifndef NUCLEX_TELECIDE_CONFIG_H
#define NUCLEX_TELECIDE_CONFIG_H

// --------------------------------------------------------------------------------------------- //

// Platform recognition
#if defined(WINAPI_FAMILY) && (WINAPI_FAMILY == WINAPI_FAMILY_APP)
  #error The Nuclex.Telecide.Native library does not support WinRT
#elif defined(WIN32) || defined(_WIN32)
  #define NUCLEX_CRIUGUI_WINDOWS 1
#else
  #define NUCLEX_TELECIDE_LINUX 1
#endif
...
// Compiler support checking
    ...
    #error At least Visual Studio 2017 is required to compile Nuclex.Telecide.Native
  #elif defined(_MSVC_LANG) && (_MSVC_LANG >= 201703L)
    #define NUCLEX_TELECIDE_CXX17 1
  #endif
#elif defined(__clang__) && defined(__clang_major__)
  #if (__clang_major__ < 5) // clang 5.0 has the C++17 features we use
    #error At least clang 5.0 is required to compile Nuclex.Telecide.Native
  #elif defined(__cplusplus) && (__cplusplus >= 201703L)
    #define NUCLEX_TELECIDE_CXX17 1
  #endif
#elif defined(__GNUC__)
  #if (__GNUC__ < 8) // GCC 8.0 has the C++17 features we use
    #error At least GCC 8.0 is required to compile Nuclex.Telecide.Native
  #elif defined(__cplusplus) && (__cplusplus >= 201703L)
    #define NUCLEX_TELECIDE_CXX17 1
  #endif
#else
  #error Unknown compiler. Nuclex.Telecide.Native is tested with GCC, clang and MSVC only
#endif
...
#if !defined(NUCLEX_TELECIDE_CXX17)
  #error The Nuclex.Telecide.Native library must be compiled in at least C++17 mode
#endif
...
// Bail out instead of letting the user scratch their head over weird compiler errors.
  ...
  #error The Nuclex.Telecide.Native library does not work in C++20 mode yet
...
// a dll (Nuclex.Telecide.Native library). The NUCLEX_CRIUGUI_SOURCE symbol is defined by
// all source files of the library, so you don't have to worry about a thing.
#if defined(_MSC_VER)

  #if defined(NUCLEX_TELECIDE_STATICLIB) || defined(NUCLEX_TELECIDE_EXECUTABLE)
    #define NUCLEX_TELECIDE_API
  #else
    #if defined(NUCLEX_TELECIDE_SOURCE)
      // If we are building the DLL, export the symbols tagged like this
      #define NUCLEX_TELECIDE_API __declspec(dllexport)
    #else
      // If we are consuming the DLL, import the symbols tagged like this
      #define NUCLEX_TELECIDE_API __declspec(dllimport)
    #endif
  #endif
  ...
  #define NUCLEX_TELECIDE_TYPE
    ...
    #define NUCLEX_TELECIDE_API __attribute__ ((visibility ("default")))
    #define NUCLEX_TELECIDE_TYPE __attribute__ ((visibility ("default")))
  #endif
...
#else
  #define NUCLEX_TELECIDE_NDEBUG_UNUSED(x) {}
#endif

// --------------------------------------------------------------------------------------------- //

#if defined(_MSC_VER)
  #define NUCLEX_TELECIDE_CPU_YIELD _mm_pause()
#elif defined(__arm__)
  #define NUCLEX_TELECIDE_CPU_YIELD asm volatile("yield")
#else
  #define NUCLEX_TELECIDE_CPU_YIELD __builtin_ia32_pause()
#endif

// --------------------------------------------------------------------------------------------- //

#endif // NUCLEX_TELECIDE_CONFIG_H
